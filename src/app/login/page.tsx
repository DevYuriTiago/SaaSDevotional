        ...
        <main className="relative min-h-dvh flex items-center justify-center px-6 py-12">
            ...
            >
                ...
                <div className="text-center mb-10">
                    ...
                    <h1 className="text-2xl font-bold mb-2" style={{ color: "var(--text-primary)" }}>Bem-vindo de volta</h1>
                ...
                <div className="glass-strong rounded-3xl p-8">
                    ...
                    <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
                        ...
                        <div>
                            <div className="flex items-center justify-between mb-2">
                                ...
                                <Link href="/forgot-password" className="text-xs" style={{ color: "var(--brand-purple)" }}>
                                    Esqueci minha senha
                                </Link>
                            </div>
                            <input
                    ...
                    <div className="mt-6 text-center">
                        <p className="text-sm" style={{ color: "var(--text-muted)" }}>
                            Não tem conta?{" "}
                            <Link href="/signup" className="font-medium" style={{ color: "var(--brand-purple)" }}>
                                Criar gratuitamente
                            </Link>
                        </p>
                    </div>
